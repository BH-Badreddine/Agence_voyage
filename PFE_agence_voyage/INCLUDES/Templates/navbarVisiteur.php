  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0 ">
        <li class="nav-item">
          <a class="nav-link active accVisiteur" href="accueil.php"><i class="fa-solid fa-house"></i><span>Accueil</span></a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link connex active btn btn-warning" href="connexion.php">Connexion</a>
        </li>
      </ul>
    </div>
  </div>
